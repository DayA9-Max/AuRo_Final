...
struct ControlLoopParameters_
{
  ...
  _output_saturation_type output_saturation;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _kAz_type;
  _kAz_type kAz;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _kBz_type;
  _kBz_type kBz;
