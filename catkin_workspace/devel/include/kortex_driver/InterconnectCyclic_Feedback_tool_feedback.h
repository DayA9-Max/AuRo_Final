...
struct InterconnectCyclic_Feedback_tool_feedback_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::GripperCyclic_Feedback_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::GripperCyclic_Feedback_<ContainerAllocator> >> _gripper_feedback_type;
