...
struct FirmwareBundleVersions_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _main_bundle_version_type;
  _main_bundle_version_type main_bundle_version;

   typedef std::vector< ::kortex_driver::FirmwareComponentVersion_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::FirmwareComponentVersion_<ContainerAllocator> >> _components_versions_type;
...
struct Printer< ::kortex_driver::FirmwareBundleVersions_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kortex_driver::FirmwareBundleVersions_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.main_bundle_version);
