...
struct RobotEventNotificationList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::RobotEventNotification_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::RobotEventNotification_<ContainerAllocator> >> _notifications_type;
