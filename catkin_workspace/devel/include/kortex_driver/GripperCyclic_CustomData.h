...
struct GripperCyclic_CustomData_
{
  ...
  _gripper_custom_data_type gripper_custom_data;
   ...
   typedef std::vector< ::kortex_driver::CustomDataUnit_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::CustomDataUnit_<ContainerAllocator> >> _motor_custom_data_type;
