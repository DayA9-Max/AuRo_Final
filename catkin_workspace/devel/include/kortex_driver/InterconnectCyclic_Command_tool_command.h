...
struct InterconnectCyclic_Command_tool_command_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::GripperCyclic_Command_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::GripperCyclic_Command_<ContainerAllocator> >> _gripper_command_type;
