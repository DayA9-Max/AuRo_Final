...
struct Map_
{
  ...
  _name_type name;
   ...
   typedef std::vector< ::kortex_driver::MapElement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::MapElement_<ContainerAllocator> >> _elements_type;
