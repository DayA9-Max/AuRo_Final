...
struct ProtectionZone_
{
  ...
  _shape_type shape;
   ...
   typedef std::vector< ::kortex_driver::CartesianLimitation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::CartesianLimitation_<ContainerAllocator> >> _limitations_type;
  _limitations_type limitations;

   typedef std::vector< ::kortex_driver::CartesianLimitation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::CartesianLimitation_<ContainerAllocator> >> _envelope_limitations_type;
