...
struct ControllerElementHandle_identifier_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _button_type;
  _button_type button;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _axis_type;
  _axis_type axis;
