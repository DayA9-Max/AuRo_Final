...
struct InterconnectCyclic_CustomData_tool_customData_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::GripperCyclic_CustomData_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::GripperCyclic_CustomData_<ContainerAllocator> >> _gripper_custom_data_type;
