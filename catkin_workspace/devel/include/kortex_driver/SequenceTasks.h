...
struct SequenceTasks_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::SequenceTask_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::SequenceTask_<ContainerAllocator> >> _sequence_tasks_type;
