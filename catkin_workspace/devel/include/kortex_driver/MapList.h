...
struct MapList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::Map_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::Map_<ContainerAllocator> >> _map_list_type;
