...
struct CartesianTrajectoryConstraint_type_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::CartesianSpeed_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::CartesianSpeed_<ContainerAllocator> >> _speed_type;
  _speed_type speed;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _duration_type;
