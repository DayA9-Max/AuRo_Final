...
struct SafetyConfigurationList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::SafetyConfiguration_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::SafetyConfiguration_<ContainerAllocator> >> _configuration_type;
