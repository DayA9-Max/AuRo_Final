...
struct Sequence_
{
  ...
  _application_data_type application_data;
   ...
   typedef std::vector< ::kortex_driver::SequenceTask_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::SequenceTask_<ContainerAllocator> >> _tasks_type;
  _tasks_type tasks;
