...
struct MapGroup_
{
  ...
  _parent_group_handle_type parent_group_handle;
   ...
   typedef std::vector< ::kortex_driver::MapGroupHandle_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::MapGroupHandle_<ContainerAllocator> >> _children_map_group_handles_type;
