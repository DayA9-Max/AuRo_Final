...
struct SensorFocusAction_action_parameters_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::FocusPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::FocusPoint_<ContainerAllocator> >> _focus_point_type;
  _focus_point_type focus_point;

   typedef std::vector< ::kortex_driver::ManualFocus_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::ManualFocus_<ContainerAllocator> >> _manual_focus_type;
