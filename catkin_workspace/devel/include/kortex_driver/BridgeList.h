...
struct BridgeList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::BridgeConfig_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::BridgeConfig_<ContainerAllocator> >> _bridgeConfig_type;
