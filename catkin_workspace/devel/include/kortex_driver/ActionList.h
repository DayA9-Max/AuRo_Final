...
struct ActionList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::Action_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::Action_<ContainerAllocator> >> _action_list_type;
