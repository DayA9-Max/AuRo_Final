...
struct TorqueCalibration_
{
  ...
  _global_offset_type global_offset;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _gain_type;
  _gain_type gain;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _offset_type;
  _offset_type offset;
