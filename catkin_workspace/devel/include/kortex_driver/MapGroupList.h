...
struct MapGroupList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::MapGroup_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::MapGroup_<ContainerAllocator> >> _map_groups_type;
