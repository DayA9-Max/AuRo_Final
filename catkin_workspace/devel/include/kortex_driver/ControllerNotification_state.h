...
struct ControllerNotification_state_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::kortex_driver::ControllerState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::ControllerState_<ContainerAllocator> >> _controller_state_type;
  _controller_state_type controller_state;

   typedef std::vector< ::kortex_driver::ControllerElementState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::kortex_driver::ControllerElementState_<ContainerAllocator> >> _controller_element_type;
